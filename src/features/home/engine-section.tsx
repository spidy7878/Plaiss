export function EngineSection() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 bg-white">
      {/* Left Content */}
      <div className="flex flex-col justify-start px-12 pt-28 pb-8">
        <h2 className="text-7xl font-normal text-black mb-8 leading-tight">
          <span className="block leading-[0.95]">The Plaiss</span>
          <span className="block leading-[0.95] mt-4">Engine</span>
        </h2>
        <p className="text-base text-black/70 mb-8 leading-relaxed max-w-md mt-24">
      ...
      {/* Right Image */}
      <div className="relative min-h-150 flex items-center justify-center mr-8">
        <img
          src="/Engine.avif"
